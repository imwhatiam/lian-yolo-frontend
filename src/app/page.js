...
if (typeof window !== 'undefined') {
  ...
  windInfoUrl = origin === 'http://127.0.0.1:3000' ? 'http://127.0.0.1:8000/stock/api/wind-info/' : origin === 'https://www.lian-yolo.com' ? 'https://www.lian-yolo.com/stock/api/wind-info/' : '';
  bigRiseVolumeStockUrl = origin === 'http://127.0.0.1:3000' ? 'http://127.0.0.1:8000/stock/api/big-rise-volume/' : origin === 'https://www.lian-yolo.com' ? 'https://www.lian-yolo.com/stock/api/big-rise-volume/' : '';
  tradingCrowdingUrl = origin === 'http://127.0.0.1:3000' ? 'http://127.0.0.1:8000/stock/api/trading-crowding/' : origin === 'https://www.lian-yolo.com' ? 'https://www.lian-yolo.com/stock/api/trading-crowding/' : '';
  industryListUrl = origin === 'http://127.0.0.1:3000' ? 'http://127.0.0.1:8000/stock/api/industry-list/' : origin === 'https://www.lian-yolo.com' ? 'https://www.lian-yolo.com/stock/api/industry-list/' : '';
}
